...
version = u"%s" % ".".join(APP_VERSION.split(".")[:-2])
# The full version, including alpha/beta/rc tags.
release = u"%s" % APP_VERSION
...
latex_documents = [
  ('index', 'pyChapel.tex', u'pyChapel Documentation',
...
man_pages = [
    ('index', 'pychapel', u'pyChapel Documentation',
     [u'Simon A. F. Lund'], 1)
]
...
texinfo_documents = [
  ('index', 'pyChapel', u'pyChapel Documentation',
   u'Simon A. F. Lund', 'pyChapel', 'One line description of project.',
   'Miscellaneous'),
]
