...
static void wrapcoforall_fn(_class_localscoforall_fn2 c) {
  ...
  *(_5_rvfDerefTmp + INT64(1)) = *((c)->_5_rvfDerefTmp + INT64(1));
  coforall_fn2(&_0_locBlock, _1_parDim, _2_numChunks, _3_chunk, _4_rvfDerefTmp, &_5_rvfDerefTmp, _ln, _fn);
...
static void chpl___ASSIGN_3(DefaultRectangularArr__real64_2_int64_t_F a, _real64 b, int64_t _ln, c_string _fn) {
  ...
  if (call_tmp11) {
    ...
    *(ret4 + INT64(1)) = *((this9)->ranges + INT64(1));
    ...
    _computeChunkStuff(T, default_argignoreRunning, default_argminIndicesPerTask, &ret4, ret_to_arg_ref_tmp_4, _ln, _fn);
...
static void wrapcoforall_fn3(_class_localscoforall_fn c) {
  ...
  *(_0_locBlock + INT64(1)) = *((c)->_0_locBlock + INT64(1));
  ...
  _6_b = (c)->_6_b;
  coforall_fn(&_0_locBlock, _1_parDim, _2_numChunks, _3_chunk, _4_rvfDerefTmp, _5_rvfDerefTmp, _6_b, _ln, _fn);
  chpl_here_free(((void*)(c)), _ln, _fn);
  return;
}
