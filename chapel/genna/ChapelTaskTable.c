...
static void chpldev_taskTable_init(int64_t _ln, c_string _fn) {
  ...
  _ref_range_int64_t_bounded_T this15 = NULL;
  int64_t i;
  int64_t ret7;
  int64_t ret8;
  int64_t ret9;
  ...
  int64_t call_tmp17;
  int64_t call_tmp18;
  DefaultRectangularArr_locale_1_int64_t_F this16 = NULL;
  ...
  this15 = &_ic__F0_this2;
  call_tmp14 = isAmbiguous(this15, _ln, _fn);
  if (call_tmp14) {
    chpl_error("these -- Attempt to iterate over a range with ambiguous alignment.", _ln, _fn);
  }
  ret7 = (&_ic__F0_this2)->_low;
  ret8 = (&_ic__F0_this2)->_alignment;
  ret9 = (&_ic__F0_this2)->_low;
  ret10 = (&_ic__F0_this2)->_stride;
  call_tmp15 = chpl__diffMod(ret8, ret9, ret10, _ln, _fn);
  call_tmp16 = (ret7 + call_tmp15);
  ret11 = (&_ic__F0_this2)->_high;
  ret12 = (&_ic__F0_this2)->_high;
  ret13 = (&_ic__F0_this2)->_alignment;
  ret14 = (&_ic__F0_this2)->_stride;
  call_tmp17 = chpl__diffMod(ret12, ret13, ret14, _ln, _fn);
  call_tmp18 = (ret11 - call_tmp17);
  end = call_tmp18;
  for (i = call_tmp16; ((i <= end)); ret16 = (&_ic__F0_this2)->_stride,i += ret16) {
    this16 = _ic__F0_this;
    ret15 = (this16)->shiftedData;
    coerce_tmp = ret15;
    ...
    (_args_forcoforall_fn)->_0_loc = call_tmp19;
  ...
  call_tmp20 = &((_field_destructor_tmp_)->_v);
  atomic_destroy_int_least64_t(call_tmp20);
  call_tmp21 = ((void*)(delete_tmp));
